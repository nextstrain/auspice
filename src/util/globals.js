...
export const defaultFocus = true;
...
export const animationWindowWidth = 0.025; // width of animation window relative to date slider
export const minDistanceDateSlider = 0.025;
