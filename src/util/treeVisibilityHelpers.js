      ...
      if (found === 0) {
        ...
        dispatch(
          warningNotification({
            ...
            details:
              "Multiple nodes in the tree are labelled '" + labelName + " " + labelValue + "' - no zoom performed"
          })
        );
        return 0;
      }
  ...
  if (found === 0) {
    ...
    dispatch(
      warningNotification({
        ...
        details:
          "The label '" + labelName + "' value '" + labelValue + "' was not found in the tree - no zoom performed"
      })
    );
  }
  return found;
