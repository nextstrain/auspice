...
export const bezier = (startPoint, endPoint, extend, num = 15) => {
  // returns Bezier curve starting at first point in pair, curving towards the second point in pair and
  ...
  N.forEach((ii) => {
    ...
    _range(curve.length).forEach((j) => {
      // iterate over future curve, adjust each point's coordinate
