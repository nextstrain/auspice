...
import { PhyloNode, Root } from "../phyloTree/types";
import { TreeComponent } from "../tree";

/* Callbacks used by the tips / branches when hovered / selected */

export const onTipHover = function onTipHover(this: TreeComponent, d: PhyloNode) {
...
export const onTipClick = function onTipClick(this: TreeComponent, d: PhyloNode) {
  if (d.visibility !== NODE_VISIBLE) return;
...
export const onBranchHover = function onBranchHover(this: TreeComponent, d: PhyloNode) {
  if (d.visibility !== NODE_VISIBLE) return;
...
export const onBranchClick = function onBranchClick(this: TreeComponent, d: PhyloNode) {
  if (d.visibility !== NODE_VISIBLE) return;
  if (this.props.narrativeMode) return;
...
export const onBranchLeave = function onBranchLeave(this: TreeComponent, d: PhyloNode) {
...
export const onTipLeave = function onTipLeave(this: TreeComponent, d: PhyloNode) {
  const phylotree = d.that.params.orientation[0] === 1 ?
    this.state.tree :
    this.state.treeToo;
...
export const clearSelectedNode = function clearSelectedNode(this: TreeComponent, selectedNode: PhyloNode) {
