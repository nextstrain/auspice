...
import { getDomId, hasSameDivergenceAsCurrentRoot, getNextParentWithDifferentDivergence } from "../phyloTree/helpers";
...
export const onBranchClick = function onBranchClick(d) {
  ...
  let arrayIdx = hasSameDivergenceAsCurrentRoot(d.n, this.props.tree) ? getNextParentWithDifferentDivergence(d.n).arrayIdx : d.n.arrayIdx;
