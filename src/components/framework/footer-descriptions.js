...
const INRB = () => {
  return (
    <div>
      <div>This work is made possible by the open sharing of genetic data by research groups.</div>
      <div className="acknowledgments">
        These sequences were generated by the Democratic Republic of the Congo Sequencing Consortium led by the Institut
        National de Recherche Biomédicales (INRB), Kinshasa, DRC, partnered with the United States Army Medical Reseach
        Insititute of Infectious Diseases (USAMRIID), Maryland, USA; University of Nebraska Medical Center (UNMC),
        Nebraska, USA; Institut Pasteur de Dakar, Dakar, Senegal; TransVIHMI, Institut de Recherche pour le
        Développement (IRD), Institut National de la Santé et de la Recherche Médicale (INSERM), Université de
      ...
      <div className="acknowledgments">
        ...
        <a
          ...
          href="http://virological.org/t/drc-2018-viral-genome-characterization/230"
        >
          virological.org
        </a>{" "}
        post, which is continually updated. If you intend to use these sequences prior to publication, please contact
        Drs. Muyembe-Tamfum and Ahuka to coordinate.
      </div>
    </div>
  );
};
...
const Ebola = (genericPreamble) => {
  return (
    <div>
      {genericPreamble}
      <div className="acknowledgments">
        Special thanks to Nick Loman, Matt Cotten, Ian Goodfellow and Paul Kellam for spearheading data sharing efforts
        during the outbreak. For a more complete phylogeographic analysis of these data see{" "}
        <a target="_blank" rel="noreferrer noopener" href="http://dx.doi.org/10.1038/nature22040">
          Dudas et al
        </a>
        . Curated data used in the paper are available at{" "}
        <a target="_blank" rel="noreferrer noopener" href="https://github.com/ebov/space-time">
          github.com/ebov/space-time
        </a>
        . The animation shown here was inspired by{" "}
        <a target="_blank" rel="noreferrer noopener" href="https://youtu.be/eWnIhWUpQiQ">
          a work
        </a>{" "}
        by{" "}
        <a target="_blank" rel="noreferrer noopener" href="http://bedford.io/team/gytis-dudas/">
          Gytis Dudas
        </a>
        .
      </div>
...
const Zika = (genericPreamble) => {
  return (
    <div>
      {genericPreamble}
      <div className="acknowledgments">
        Special thanks to Nick Loman, Nathan Grubaugh, Kristof Theys, Nuno Faria, Kristian Andersen, Andrew Rambaut and
        Karl Erlandson for data sharing, comments and suggestions.
      </div>
    </div>
  );
};
...
const Mumps = (genericPreamble) => {
  return (
    <div>
      {genericPreamble}
      <div className="acknowledgments">
        Special thanks to Duah Alkam, Piroon Jenjaroenpun , Thidathip Wongsurawat, Zulema Udaondo, Preecha
        Patumcharoenpol, Michael Robeson, Dirk Haselow, William Mason, Intawat Nookaew, David Ussery, Se-Ran Jun,
        Jennifer Gardy, Shirlee Wohl, Jeff Joy, Patrick Stapleton, Nathan Yozwiak, Hayden Metsky, Agatha Jassem, Louise
        Moncla, Gytis Dudas and Pardis Sabeti for data sharing, comments and suggestions.
      </div>
    </div>
  );
};
  ...
  return (
    <div className="acknowledgments">
      ...
      <a
        target="_blank"
        rel="noreferrer noopener"
        href="http://virological.org/t/new-lassa-virus-genomes-from-nigeria-2015-2016/191"
      >
        {"this viroligical.org post. "}
      </a>
      {"If you intend to use these sequences prior to publication, please contact them directly to coordinate. "}
      <span className={"link"} onClick={() => dispatch(applyFilter("set", "authors", ["Odia_et_al"]))}>
        {"Click here"}
      </span>
      ...
      <a target="_blank" rel="noreferrer noopener" href="http://virological.org/t/2018-lasv-sequencing-continued/192/8">
        {"this viroligical.org post"}
      </a>
      {", which is continually updated. "}
      <span className={"link"} onClick={() => dispatch(applyFilter("set", "authors", ["ISTH-BNITM-PHE"]))}>
        {"Click here"}
      </span>
      {" here to see these sequences in isolation."}
    </div>
...
const WNV = (dispatch) => {
  return (
    <div className="acknowledgments">
      ...
      <a target="_blank" rel="noreferrer noopener" href="http://bedford.io/team/james-hadfield/">
        {"James Hadfield"}
      </a>
      {` and `}
      <a target="_blank" rel="noreferrer noopener" href="http://grubaughlab.com">
        {"Nathan Grubaugh's lab."}
      </a>
      <p />
      ...
      <a target="_blank" rel="noreferrer noopener" href="https://www.nature.com/articles/nprot.2017.066">
        {"Zika virus sequencing"}
      </a>
      {` on the Illumina and Minion platforms for West Nile Virus circulating in North America. Their `}
      <a target="_blank" rel="noreferrer noopener" href="http://grubaughlab.com/open-science/amplicon-sequencing/">
        {"sequencing protocol and primers"}
      </a>
      {` are free to use.
      ...
      <span className={"link"} onClick={() => dispatch(changeColorBy("wnv_strain"))}>
        {"click here"}
      </span>
      {
...
const H7N9 = () => {
  return (
    <div className="acknowledgments">
      We thank the{" "}
      <a target="_blank" rel="noreferrer noopener" href="https://gisaid.org">
        GISAID Initiative
      </a>{" "}
      for enabling genomic surveillance of influenza and for providing a critical data sharing platform, and all of the
      groups who contribute to it.
    </div>
  );
};
  ...
  return (
    <div>
      <div className="acknowledgments">
        ...
        and the{" "}
        <a target="_blank" rel="noreferrer noopener" href="http://www.who.int/influenza/gisrs_laboratory/en/">
          GISRS Network
        </a>{" "}
        for critical surveillance efforts and open data sharing. Titer data used in antigenic analysis was generated by
        the{" "}
        <a target="_blank" rel="noreferrer noopener" href="https://www.cdc.gov/flu/">
          Influenza Division at the US Centers for Disease Control and Prevention
        </a>
        , the{" "}
        <a target="_blank" rel="noreferrer noopener" href="http://www.crick.ac.uk/research/worldwide-influenza-centre">
          Worldwide Influenza Centre at the Francis Crick Institute
        </a>
        , the{" "}
        <a target="_blank" rel="noreferrer noopener" href="http://www.vidrl.org.au/">
          Victorian Infectious Diseases Reference Laboratory at the Australian Peter Doherty Institute for Infection and
          Immunity
        </a>{" "}
        and the{" "}
        <a target="_blank" rel="noreferrer noopener" href="https://www.niid.go.jp/niid/en/flu-e.html">
          Influenza Virus Research Center at the Japan National Institute of Infectious Diseases
        </a>
        .
      </div>
      <div className="acknowledgments">
        Special thanks to Jackie Katz, Dave Wentworth, Becky Garten, Vivien Dugan, Xiyan Xu, Elizabeth Neuhaus, Sujatha
        Seenu, John McCauley, Rod Daniels, Vicki Gregory, Kanta Subbarao, Ian Barr, Aeron Hurt, Takato Odagiri, Shinji
        Watanabe, Tomoko Kuwahara, Michael Lässig, Marta Łuksza, Richard Reeve, Colin Russell, Sebastian Maurer-Stroh
        and Peter Bogner for feedback and advice. This analysis represents an updated frontend to the Nextflu informatic
        pipeline, originally available at nextflu.org.
      </div>
