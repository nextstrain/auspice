  ...
  return (
    <div>
      ...
      <div className="acknowledgments">
        These sequences were generated by the Democratic Republic of the Congo Sequencing Consortium
        led by the Institut National de Recherche Biomédicales (INRB), Kinshasa, DRC, partnered with
        the United States Army Medical Reseach Insititute of Infectious Diseases (USAMRIID),
        Maryland, USA; University of Nebraska Medical Center (UNMC), Nebraska, USA; Institut Pasteur
        de Dakar, Dakar, Senegal; TransVIHMI, Institut de Recherche pour le Développement (IRD),
        Institut National de la Santé et de la Recherche Médicale (INSERM), Université de
      ...
      <div className="acknowledgments">
        ...
        post, which is continually updated. If you intend to use these sequences prior to
        publication, please contact Drs. Muyembe-Tamfum and Ahuka to coordinate.
      </div>
    </div>
  );
};
...
const Ebola = (genericPreamble) => {
  return (
    <div>
      {genericPreamble}
      <div className="acknowledgments">
        Special thanks to Nick Loman, Matt Cotten, Ian Goodfellow and Paul Kellam for spearheading
        data sharing efforts during the outbreak. For a more complete phylogeographic analysis of
        these data see{' '}
        <a target="_blank" rel="noreferrer noopener" href="http://dx.doi.org/10.1038/nature22040">
          Dudas et al
        </a>. Curated data used in the paper are available at{' '}
        <a target="_blank" rel="noreferrer noopener" href="https://github.com/ebov/space-time">
          github.com/ebov/space-time
        </a>. The animation shown here was inspired by{' '}
...
const Zika = (genericPreamble) => {
  return (
    <div>
      {genericPreamble}
      <div className="acknowledgments">
        Special thanks to Nick Loman, Nathan Grubaugh, Kristof Theys, Nuno Faria, Kristian Andersen,
        Andrew Rambaut and Karl Erlandson for data sharing, comments and suggestions.
      </div>
    </div>
  );
};
...
const Mumps = (genericPreamble) => {
  return (
    <div>
      {genericPreamble}
      <div className="acknowledgments">
        Special thanks to Duah Alkam, Piroon Jenjaroenpun , Thidathip Wongsurawat, Zulema Udaondo,
        Preecha Patumcharoenpol, Michael Robeson, Dirk Haselow, William Mason, Intawat Nookaew,
        David Ussery, Se-Ran Jun, Jennifer Gardy, Shirlee Wohl, Jeff Joy, Patrick Stapleton, Nathan
        Yozwiak, Hayden Metsky, Agatha Jassem, Louise Moncla, Gytis Dudas and Pardis Sabeti for data
...
const Lassa = (dispatch) => {
  return (
    <div className="acknowledgments">
      ...
      {' and '}
      <a href="https://rega.kuleuven.be/cev/ecv/lab-members/PhilippeLemey.html">
        {'Philippe Lemey'}
      </a>
      ...
      <a
        target="_blank"
        rel="noreferrer noopener"
        href="http://virological.org/t/2018-lasv-sequencing-continued/192/8"
      >
        {'this viroligical.org post'}
      </a>
  ...
  return (
    <div className="acknowledgments">
      ...
      <a
        target="_blank"
        rel="noreferrer noopener"
        href="https://www.nature.com/articles/nprot.2017.066"
      >
      ...
      <a
        target="_blank"
        rel="noreferrer noopener"
        href="http://grubaughlab.com/open-science/amplicon-sequencing/"
      >
      ...
      <ul>
        <li>
          <span
            className={'link'}
            onClick={() =>
              dispatch(changeColorBy(encodeColorByGenotype({gene: 'env', positions: [159]})))
            }
          >
            {'env-V159A'}
          </span>
        ...
        <li>
          <span
            className={'link'}
            onClick={() =>
              dispatch(changeColorBy(encodeColorByGenotype({gene: 'NS4A', positions: [85]})))
            }
          >
            {'NS4A-A85T'}
          </span>
...
const H7N9 = () => {
  return (
    <div className="acknowledgments">
      ...
      for enabling genomic surveillance of influenza and for providing a critical data sharing
      platform, and all of the groups who contribute to it.
    </div>
  );
};
  ...
  return (
    <div>
      <div className="acknowledgments">
        ...
        for critical surveillance efforts and open data sharing. Titer data used in antigenic
        analysis was generated by the{' '}
        ...
        <a target="_blank" rel="noreferrer noopener" href="http://www.vidrl.org.au/">
          Victorian Infectious Diseases Reference Laboratory at the Australian Peter Doherty
      ...
      <div className="acknowledgments">
        ...
        Elizabeth Neuhaus, Sujatha Seenu, John McCauley, Rod Daniels, Vicki Gregory, Kanta Subbarao,
        Ian Barr, Aeron Hurt, Takato Odagiri, Shinji Watanabe, Tomoko Kuwahara, Michael Lässig,
        Marta Łuksza, Richard Reeve, Colin Russell, Sebastian Maurer-Stroh and Peter Bogner for
        feedback and advice. This analysis represents an updated frontend to the Nextflu informatic
