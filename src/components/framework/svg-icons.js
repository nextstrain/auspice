        ...
        <svg width={width} height={width} viewBox="16 19 27 22">
          ...
          >
            <polyline
              id="Path-3"
              stroke={stroke}
              points="2.94117647 12.8571429 2.94117647 18.6083984 17.8459616 18.6083984 17.8459616 16.0260882 24.870031 16.0260882"
            />
            <polyline
              id="Path-4"
              stroke={stroke}
              points="17.8500004 18.5714286 17.8500004 20 25.0119374 20"
            />
            <polyline
              id="Path-5"
              stroke={stroke}
              points="2.94117647 12.8571429 3.00303284 7.21191058 10.2360102 7.11220045 10.4159559 2.99881623 17.1561911 2.93803403 17.1561911 0 24.313534 0"
            />
            <polyline
              id="Path-6"
              stroke={stroke}
              points="17.1599998 2.85714286 17.1599998 4.28571429 24.512941 4.28571429"
            />
            <path d="M0,12.8571429 L2.94117647,12.8571429" id="Path-6" stroke={stroke} />
            <polyline
              id="Path-7"
              stroke={stroke}
              points="10.2941176 7.14285714 10.2941176 11.4285714 24.5454676 11.4285714"
            />
          </g>
        </svg>
      </g>
      ...
      <g transform="translate(0,0)">
        <svg width={width} height={width} viewBox="14 14 25 26">
          ...
          >
            ...
            <path
              d="M15.229248,22.5795898 L15.229248,18.2854004 C15.229248,18.2854004 17.8465223,17.6291504 17.8508301,15.0574951 C17.8551378,12.4858398 15.2944336,11.9138184 15.2944336,11.9138184 L15.229248,7.53540039"
              id="Path-13"
              stroke={stroke}
            />
            <path
              d="M7.63037109,6.10498047 L10.230957,9.08325195 C10.230957,9.08325195 12.25,7.08233714 15.126709,7.04162598 C18.003418,7.00091481 20.5390625,8.91748047 20.5390625,8.91748047 L22.9765625,5.60839844"
              id="Path-14"
              stroke={stroke}
            />
            <path
              d="M0.15942005,4.99135298 L2.76065146,7.96962446 C2.76065146,7.96962446 4.78019556,5.96870965 7.65761856,5.92799848 C10.5350415,5.88728732 13.0713154,7.80385298 13.0713154,7.80385298 L15.5094204,4.49477094"
              id="Path-14"
              stroke={stroke}
              transform="translate(7.834420, 6.232198) rotate(-34.000000) translate(-7.834420, -6.232198) "
            />
            <path
              d="M7.5,21.496582 L10.1005859,24.4748535 C10.1005859,24.4748535 12.1196289,22.4739387 14.9963379,22.4332275 C17.8730469,22.3925164 20.4086914,24.309082 20.4086914,24.309082 L22.8461914,21"
              id="Path-14"
              stroke={stroke}
              transform="translate(15.173096, 22.737427) scale(1, -1) translate(-15.173096, -22.737427) "
            />
          </g>
        </svg>
      </g>
    ...
    <svg width={width} height={width + 5}>
      <g transform="translate(0,2)">
        <svg width={width} height={width} viewBox="106 49 150 118">
          ...
          />
          <path
            d="M192,119.2 L229.854937,164.55391"
            id="Path-6"
            stroke={stroke}
            strokeWidth="4"
            fill="none"
