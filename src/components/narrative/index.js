...
import { NarrativeStyles, linkStyles, OpacityFade, EndOfNarrative, ProgressBar, ProgressButton } from "./styles";
...
class Narrative extends React.Component {
  ...
  renderProgress() {
    return (
      <ProgressBar style={{ height: `${progressHeight}px` }} role="navigation">
        {this.props.blocks.map((b, i) => {
          const d = !this.state.showingEndOfNarrativePage && this.props.currentInFocusBlockIdx === i ? "14px" : "6px";
          return (
            <ProgressButton
              key={i}
  ...
  renderBlocks() {
    ...
    ret.push(
      <EndOfNarrative key="EON" id="EndOfNarrative">
        ...
        <a style={{ ...linkStyles }} onClick={() => this.reactPageScroller.goToPage(0)}>
  ...
  render() {
    ...
    return (
      <NarrativeStyles id="NarrativeContainer" narrativeNavBarHeight={narrativeNavBarHeight}>
        {this.renderProgress()}
