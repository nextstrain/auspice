...
const Chevron = ({pos, height, width, callback}) => {
  ...
  return (
    <span
      ...
      style={{top: `${top}px`, minWidth: width, minHeight: "3em", position: "absolute", backgroundColor: "orange", cursor: "pointer"}}
      onClick={callback}
    />
  );
};
...
export class Gutter extends React.Component { // eslint-disable-line
  render() {
    ...
    return (
      <div style={{minWidth: `${this.props.width}px`, minHeight: `${this.props.height}px`, maxHeight: `${this.props.height}px`, backgroundColor: "skyblue", position: "relative"}}>
