...
const Content = hasExtension("navbarComponent") ? getExtension("navbarComponent") : AuspiceNavBar;
...
const NavBar = ({ sidebar, toggleHandler, narrativeTitle, width }) => {
  ...
  return (
    <NavBarContainer>
      <Content narrativeTitle={narrativeTitle} sidebar={sidebar} width={width} />
      <SidebarChevron
        navHeight={normalNavBarHeight}
        navWidth={width}
        display={showSidebarToggle}
