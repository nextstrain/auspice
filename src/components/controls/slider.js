...
const Slider = createReactClass({
  ...
  _renderBar(i, offsetFrom, offsetTo) {
    ...
    return <div key={"bar" + i} ref={"bar" + i} className={className} style={{ ...styles.bar, ...barStyle }} />;
  },
  ...
  render() {
    ...
    const orientation = this.props.orientation === "vertical" ? styles.verticalSlider : styles.horizontalSlider;
